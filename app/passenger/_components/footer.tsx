...
export const Footer = () => {
  ...
  return (
    <footer className="bg-white text-[#33576E] py-10">
      <div className="w-full max-w-7xl mx-auto px-5">
        ...
        <div className="mt-10 flex justify-center sm:justify-start space-x-5">
          <Link
            href="/"
            className="text-[#33576E] hover:text-sky-400 transition"
          >
            <Facebook size={24} />
          </Link>
          <Link
            href="/"
            className="text-[#33576E] hover:text-pink-600 transition"
          >
            <Instagram size={24} />
          </Link>
          <Link
            href="/"
            className="text-[#33576E] hover:text-blue-400 transition"
          >
            <Twitter size={24} />
          </Link>
          <Link
            href="/"
            className="text-[#33576E] hover:text-slate-800 transition"
          >
            <Linkedin size={24} />
          </Link>
        </div>
